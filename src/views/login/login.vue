<template>
  <div class="login-container">
    ...
    <div class="login-plane" :style="{width: `${600 * scale.x}px`}">
      <div class="login-plane-container">
        ...
        <div class="login-plane-form">
          <a-form :model="formField" :rules="formRules" ref="formRef" autocomplete="off">
            <a-form-item name="user">
              <a-input placeholder="用户名 / 账号" type="text" v-model:value="formField.user"></a-input>
            </a-form-item>
            <a-form-item name="pass">
              <a-input placeholder="密码" type="password" v-model:value="formField.pass"></a-input>
            </a-form-item>
            <div class="login-code-container">
              <a-form-item style="width: 50%" name="code">
                <a-input placeholder="验证码" type="text" v-model:value="formField.code"></a-input>
              </a-form-item>
              <div @click="getValidateCodeHandle" class="login-code">
                <img :src="codeSrc" />
              </div>
            </div>
            <a-form-item prop="autoLogin">
              <a-checkbox v-model:checked="formField.whetherAutoLogin">自动登陆</a-checkbox>
            </a-form-item>
          </a-form>
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      window.onresize = () => {
        ...
        scale.x = window.innerWidth / 1920
        scale.y = window.innerHeight / 937
    ...
    const initSceneBg = () => {
      new THREE.TextureLoader().load(require('@/assets/images/sky.png'), (texture: any) => {
        const geometry = new THREE.BoxGeometry(1.2 * width, 1.2 * height, depth) // 创建一个球形几何体 SphereGeometry
